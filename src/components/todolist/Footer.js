...
const Footer = (props) => {
  ...
  return (
    <div className="footer">
      ...
      <div className="footerul"><ul className="filterul">
        <li><a onClick={() => handleClick("all")}>All</a></li>
        <li><a onClick={() => handleClick("completed")}>Completed</a></li>
        <li><a onClick={() => handleClick("active")}>Active</a></li>
        </ul>
        </div>
    </div>
  );
